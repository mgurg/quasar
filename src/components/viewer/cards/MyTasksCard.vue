  ...
  <q-card bordered class="my-card no-shadow q-mt-sm">
    <q-card-section>
      <div class="row q-col-gutter-xs">
        <div class="text-h6 text-weight-regular cursor-pointer" @click="expandedMyTasks = !expandedMyTasks">
          Moje zadania
        ...
        />
        <q-btn
          :icon="expandedMyTasks ? 'keyboard_arrow_up' : 'keyboard_arrow_down'"
          color="grey"
          dense
          flat
          round
          @click="expandedMyTasks = !expandedMyTasks"
        />
      </div>
    </q-card-section>

    <q-separator v-if="expandedMyTasks"/>
    <q-slide-transition>
...
const expandedMyTasks = ref(props.expandedMyTasks)
