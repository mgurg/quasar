<template>
    <div @click="handleSelect(permission.uuid)">
        <q-item :class="{ 'done bg-blue-1': permission.uuid == selected }">
            ...
            <q-item-section>
                ...
                <q-item-label lines="1"> {{ permission.role_description }}
                    <q-chip square size="sm" color="blue-12" icon="star" text-color="white" v-if="permission.is_custom == false"></q-chip>
