...
const routes = [
  ...
  // },
  {
    ...
    children: [
      ...
      { path: "/settings/groups/add", component: () => import("pages/Settings/SettingsGroupsView.vue") },
      { path: "/settings/groups/:uuid", component: () => import("pages/Settings/SettingsGroupsView.vue") },
